...
<!-- Le chunk ci-dessous ne doit pas être modifié. Il est présent afin de permettre une correction semi-automatisée de ce document. -->
...
fs::dir_create(here::here("test"))
write$rds(obj_check, here::here("test", "seaweed_check.rds"), compress = "xz")
```
